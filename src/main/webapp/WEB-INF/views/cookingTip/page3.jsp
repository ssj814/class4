...
<div class="container1">
    ...
    <div class="item item-container">
        <img src="resources/img/cookingTip/microwave/5.jpg" class="img-fluid" alt="Step 4">
        <p class="instruction-text">4. 랩을 씌우고 포크로 구멍을 뚫어주세요</p>
    </div>
    <div class="item item-container">
        <img src="resources/img/cookingTip/microwave/6.jpg" class="img-fluid" alt="Step 5">
