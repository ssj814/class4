...
<div class="container text-center d-block p-0">
    <c:forEach var="item" items="${wishProductList}">
        <div id="wish-${item.wish.wish_id}" class="row align-items-center border border-dark rounded" style="margin-bottom:0.3px">
            <div class="col-1">
                <input class="product-check form-check-input m-0 border border-dark" type="checkbox" value="${item.wish.wish_id}">
            </div>
            <div class="col-2">
                <a href="shopDetail?productId=${item.wish.product_id}">
                    <img src="<c:url value='/images/shoppingMall_product/${item.product.product_imagename}'/>" alt="Image" class="w-75" style="object-fit: contain; max-height: 100px; width: 100%;">
                </a>
            </div>
            <div class="col-5 text-start">
                <h2>
                    <a href="shopDetail?productId=${item.wish.product_id}" class="text-dark fw-bold text-decoration-none fs-6">
            ...
            <div class="col-1">
                ...
                <button type="button" class="btn-cart btn btn-outline-dark mb-1" data-id="${item.wish.wish_id}" data-product-id="${item.wish.product_id}" style="font-size:15px">장바구니</button>
