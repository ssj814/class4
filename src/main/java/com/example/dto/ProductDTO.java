...
public class ProductDTO {
	...
	public String toString() {
		return "ProductDTO [product_id=" + product_id + ", product_category_id=" + product_category_id + ", product_name="
				+ product_name + ", product_price=" + product_price + ", product_description=" + product_description
				+ ", product_imagename=" + product_imagename + ", product_inventory=" + product_inventory
				+ ", product_totalsales=" + product_totalsales + ", product_view=" + product_view
